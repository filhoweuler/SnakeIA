...
def on_grid_random():
    x = random.randint(TILE_SIZE,570)
    y = random.randint(TILE_SIZE,570)
...
def walk(head, vector):
    ...
    '''
    return (head[0] + TILE_SIZE * vector[0], head[1] + TILE_SIZE * vector[1])
...
snake = [(200, 200), (200 + TILE_SIZE, 200), (200 + TILE_SIZE * 2,200)]
snake_skin = pygame.Surface((TILE_SIZE,TILE_SIZE))
...
while True:
    ...
    if my_direction == UP:
        snake[0] = (snake[0][0], snake[0][1] - TILE_SIZE)
        info.append([1,0,0,0])
    if my_direction == DOWN:
        snake[0] = (snake[0][0], snake[0][1] + TILE_SIZE)
        info.append([0,0,1,0])
    if my_direction == RIGHT:
        snake[0] = (snake[0][0] + TILE_SIZE, snake[0][1])
        info.append([0,1,0,0])
    ...
    if (snake[0][0] <= 0 or snake[0][0] >= 600 - TILE_SIZE or snake[0][1] <= 0 or snake[0][1] >= 600 - TILE_SIZE):
        game_over = True
    ...
    for x in range(0,600,TILE_SIZE):
        screen.blit(wall,(0, x))
        screen.blit(wall,(600 - TILE_SIZE, x))
        screen.blit(wall,(x, 0))
        screen.blit(wall,(x, 600 - TILE_SIZE))
